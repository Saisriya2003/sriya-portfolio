...
export const experience = [
  {
    ...
    points: [
      ...
      "Collaborated with cross-functional teams to deliver AI-driven and web-based solutions aligned with business goals.",
    ],
  },
];
...
export const skills = {
  ...
  "Web & Frameworks": ["React", "HTML", "CSS", "FastAPI", "Node.js", "Express"],
  Databases: ["SQL", "MongoDB", "PostgreSQL"],
  "Developer Tools": ["Git", "GitHub", "VS Code"],
  Focus: ["REST APIs", "GenAI", "RAG", "Dashboards", "Responsive UI"],
};
...
export const education = [
  ...
  },
  {
    ...
    degree: "Intermediate",
    place: "Bheemadevarapalle, Telangana",
